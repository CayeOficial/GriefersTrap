...
(async () => {
    ...
    try {
        ...
        We suggest you to check that everything is alright, please run 'ipset list' on your terminal, if no set matches 'grieferstrap' name, delete the '.ipset' file and re-run this app.\n
